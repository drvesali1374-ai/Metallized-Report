...
export const metadata = {
  title: "سامانه مانیتورینگ متالایز | اپلیکیشن آفلاین",
  description:
    "سامانه مانیتورینگ متالایز — پایش هوشمند رول‌ها، ستاپ‌ها و فرآیند تولید؛ کاملاً آفلاین — بدون سرور، بدون نصب، بدون اینترنت",
};
      ...
      <header className="border-b bg-card/80 backdrop-blur supports-[backdrop-filter]:bg-card/60">
        <div className="mx-auto flex max-w-[1400px] flex-wrap items-center justify-between gap-3 px-4 py-3">
          <div className="flex items-center gap-3">
            <img
              src="/roll-monitor/lib/logo.png"
              alt="لوگوی سامانه مانیتورینگ متالایز"
              className="size-10 rounded-xl object-contain"
            />
            <div>
              <h1 className="text-sm font-bold leading-5">
                سامانه مانیتورینگ متالایز
              </h1>
              <p className="text-xs text-muted-foreground">
                پایش هوشمند رول‌ها، ستاپ‌ها و فرآیند تولید — پیش‌نمایش زنده در کادر پایین
              </p>
            </div>
          </div>
      ...
      <main className="flex flex-1 flex-col">
        <div className="relative flex-1">
          <iframe
            ...
            title="پیش‌نمایش سامانه مانیتورینگ متالایز"
