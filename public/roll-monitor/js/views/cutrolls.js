...
(function () {
  ...
  CutView.renderTable = async function () {
    ...
    UI.filterTable(wrap, columns, sorted, {
      ...
      footerNote: 'فیلتر هر ستون زیر سرستون همان ستون · منطق: شامل بودن (اعداد و متن‌ها) · دکمهٔ «≠» = شامل نشود · فوکوس حفظ می‌شود · باکس‌های Σ (تعداد + وزن) با دیتای فیلترشده به‌روز می‌شوند · تعداد در ستاپ/برش‌نخورده = الگو × تعداد ست × تعداد مادر · وزن در ستاپ/برش‌نخورده = فرمول ۰٫۳۶۲ · سایر وزن‌ها = وزن خالص واقعی فایل',
